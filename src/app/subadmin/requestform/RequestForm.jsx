...
//     e.preventDefault();
//     try {
//       const response = await fetch('http://localhost:8080/subadmin/signup', {
//         method: 'POST',
//         headers: {
...
//             {/* Password */}
//             <div>
//                 <label htmlFor="password" className='text-sm font-medium block mb-2 text-gray-300'>Password
//                 </label>
//                 <input 
//                 type="password" 
//                 name='password' 
...
//               {/* Re-Enter Password */}
//               <div>
//                 <label htmlFor="password" className='text-sm font-medium block mb-2 text-gray-300'>Re-Enter Password
//                 </label>
//                 <input 
//                 type="password" 
//                 name='rePassword' 
